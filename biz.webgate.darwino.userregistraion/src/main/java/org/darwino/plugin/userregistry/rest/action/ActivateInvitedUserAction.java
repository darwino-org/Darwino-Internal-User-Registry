...
public class ActivateInvitedUserAction extends AbstractUserRegistryAction {

	public ActivateInvitedUserAction() {
		super("activateinviteduser", new String[] { "POST" });
	}
	...
	protected RequestResult executeSpecificAction(HttpServiceContext context, UserRegistrationBean bean) throws JsonException, UserRegistrationException {
		...
		bean.getUserRegistryAPI().activateInvitedUser(confirmationId, userProfile, context);
