...
public class ChangePasswordAction extends AbstractUserRegistryAction {

	public ChangePasswordAction() {
		super("changepassword", new String[] { "POST" });
	}
	...
	protected RequestResult executeSpecificAction(HttpServiceContext context, UserRegistrationBean bean) throws JsonException, UserRegistrationException {
		...
		bean.getUserRegistryAPI().changePassword(userProfile, context);
