...
import biz.webgate.darwino.samples.app.config.UserRegistrationSetupConfig;
...
public class AppPlugin extends AppBasePlugin {
	...
	public void findExtensions(Class<?> serviceClass, List<Object> extensions) {
		...
		} else if ( serviceClass == UserRegistrationSetupService.class){
			extensions.add(new UserRegistrationSetupConfig());
		}
	}
}
